...
>The aim of this project was to create a patient tracking and monitoring application using PIP tags. 
...
* The third one monitors the light conditions of a room. Depending on the patient's presence in the room, the light is turned on/off. This will reduce the patient’s efforts.
